...
import {
    // getlocalIPAddressbypoolID,
    useGetIPAddressbypoolIdQuery,
} from "@/features/IPAddress/hooks/IPAddress"
import { useState } from "react"
import { IPAddress } from "@/features/IPAddress/types"
...
export const PoolModule: React.FC<Props> = ({
    id,
    // name,
    type,
    cidr,
    ...
    const { data: IPaddress } = useGetIPAddressbypoolIdQuery(id) as {
        data: IPAddress
    }
                ...
                <div className={styles.frame}>
                    ...
                    <p className={styles.item}>
                        ...
                        <span className={styles.value}>
                            {" "}
                            {updated_at
                                ? updated_at.toLocaleString().split("T")[0]
                                : ""}
                        </span>
                    </p>
                    ...
                    <p className={styles.item}>
                        ...
                        <span className={styles.value}>
                            {created_at
                                ? created_at.toLocaleString().split("T")[0]
                                : ""}
                        </span>
                    </p>
                </div>
